...
public class LoanServiceImpl implements LoanService {
    ...
    public List<LoanEntity> getAll() throws NotFoundException {
        var loanModel = loanRepository.getAll();
        return this.loanMapper.modelToEntity(loanModel);
    }

    public List<LoanEntity> getCurrentLoan()throws NotFoundException {
    ...
    @Override
    public List<LoanEntity> getCurrentLoanOfUser(int userId) throws NotFoundException {
